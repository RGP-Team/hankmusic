<!--main content start-->
        <input type="hidden" id="_token" value="<?php echo csrf_token(); ?>"/>
          ...
          <div class="container-fluid1">
            ...
            <div class="row" style="background-color: #F4F7FA;">
                ...
                <ul class="nav nav-pills nav-stacked home-side-menu-cont">
                  ...
                  <li class="nav-menu-items">
                    ...
                    <ul>
                      ...
                      <li><a  href="javascript:bpmSearch('91-110');">91 to 110</a></li>
              ...
              <div class="col-xs-9 hm-main-cont-wrap" style="margin-bottom:-80px">
                              ...
                              <div class="hm-music-playNbuy-cont">
                                  ...
                                  <div class="playNbuy-cont">
                                      ...
                                      <div class="hm-music-loop-right-cont">
                                          ...
                                          @if(CustomHelper::isAddedToCart($music->id)==0)
                                          <div class="hm-buy-track mid_{{$music->id}}">
                                            <a href="javascript:buyMusicAjax({{$music->id}})"><button class="btn btn-primary cstm-btn "><i class="fa fa-shopping-cart hm-shopping-cart" aria-hidden="true"></i>
     ...
     Buy Track</button></a><br>
              ...
              <div class="clearfix"></div>
              <div class="footer-links" style="    width: 233px;
    bottom: 30px;
    padding: 8px;
    position: relative;
    padding-bottom: 0px;">
                  <ul style="list-style: none;font-size:12px;margin-left:-10px;margin-right:-10px;">
                    ...
                    <li style="float:left;"><a href="{{url('/')}}/contactus">Contact</a>&nbsp;|&nbsp;</li>
                              ...
                              qhtml +=  '<div class="hm-music-playNbuy-cont">';
                                  ...
                                  qhtml += '<div class="playNbuy-cont">';
                                      ...
                                      qhtml += '<div class="hm-music-loop-right-cont">';
                                          ...
                                          qhtml += '</div>';
                                          qhtml += '<a href="{{url('/')}}/producerfeatureprofile/"'+v.producer_id+'">';
