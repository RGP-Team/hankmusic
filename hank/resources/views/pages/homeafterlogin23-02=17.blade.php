<!--main content start-->
                ...
                <ul class="nav nav-pills nav-stacked home-side-menu-cont">
                  <li class="active dropdown">
                    ...
                    <ul class="dropdown-menu cstm-home-child-menu">
                      ...
                      <li style="display:none;"><a data-toggle="tab"href="#bpm">bpm</a></li>
                    </ul>
                  </li>
                  <li><a data-toggle="tab"href="#category">Producer</a></li>
                  <li class="active dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">BPM
                    <!--<span class="caret"></span>--></a>
                    <ul class="dropdown-menu cstm-home-child-menu">
                      <li><a href="javascript:bpmSearch('1-10');">1 to 10</a></li>
                      <li><a  href="javascript:bpmSearch('11-20');">11 t0 20</a></li>
                      <li><a  href="javascript:bpmSearch('21-30');">21 to 30</a></li>
                      <li><a  href="javascript:bpmSearch('31-40');">31 to 40</a></li>
                      <li><a href="javascript:bpmSearch('41-50');">41 to 50</a></li>
                      <li><a  href="javascript:bpmSearch('51-60');">51 to 60</a></li>
                      <li><a  href="javascript:bpmSearch('61-70');">61 to 70</a></li>
                      <li><a href="javascript:bpmSearch('71-80');">71 to 80</a></li>
                      <li><a href="javascript:bpmSearch('81-90');">81 to 90</a></li>
                      <li><a href="javascript:bpmSearch('91-100');">91 to 100</a></li>
                    </ul>
                  </li>
                </ul>
                                  ...
                                  <div class="playNbuy-cont">
                                      <div class="hm-music-cont">
                                          <div class="hm-music-play-tp">
                                            <a onclick="playAudio('{{$music->file_path}}')" style="cursor: pointer"><i class="fa fa-play hm-ply-btn-tp" aria-hidden="true"></i></a>
                                          </div>
     ...
     Buy Track</button></a><br>
                                  ...
                                  <div class="playNbuy-cont">
                                      <div class="col-md-2">
                                          <div class="pull-right">
                                            @if($music->user_pics)
                                            <img id="profilepic" style="width:100px;" src="{{ url('/') }}/assets/profilepic/{{$music->user_pics}}" alt="..." class="img-circle profile_img1">
                                            @else
                                            <img id="profilepic" style="width:100px;" src="{{ url('/') }}/images/profile.jpg" alt="..." class="img-circle profile_img1">
                                            @endif
                                          </div>
                                      </div>
                                      <div class="col-md-4" style="margin-top: 2%;">
                                        <h4><a href="{{url('/')}}/producersonglist/{{$music->id}}"><span class="hm-music-forward-btn1">{{$music->first_name}} {{$music->last_name}}</span></a></h4>
                                      </div>
                                  </div>
                      ...
                      <div id="bpm" class="tab-pane fade">
                        <!-- <h3>BPM</h3> -->
                        <!--home music loop start 1-->
