          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-xs-3 hm-side-nav-wrap">
                ...
                <div class="footer-links" style="margin-top:150px;">
              ...
              <div class="email-confirmed-notification">
              	<h2 class="alert alert-success" id="email-confirmed" style="padding:10px;text-align: center;">Your account is now confirmed! You may now log in to your account.</h2>
              </div>
