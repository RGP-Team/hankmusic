...
<html lang="en"><head>
  ...
  <section id="container" class="">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-xs-3 hm-side-nav-wrap">
                ...
                <div class="footer-links" style="margin-top:150px;display:none;">
                  <ul style="list-style: none;font-size:12px;">
                    ...
                    <li style="float:left;"><a href="{{url('/')}}/cookie-policy">Cookie Policy</a>&nbsp;<a href="{{url('/')}}">@ 2017 HankMusic</a></li>
                  </ul>
                </div> 
              </div>
    ...
    padding-bottom: 0px;">
      ...
      <!--main content end-->
      <div class="row" style="background-color:#1E1E1E; height: 70px;display:none;">
    ...
    success:function(resp){
      ...
      $.each(resp, function(i, v){
        ...
        qhtml = '<div class="hm-music-loop-cont">';
                              ...
                              qhtml += '<img width="100%" src="{{ url('/') }}/hank/resources/audio/musiccover/"'+v.id+'"/"'+v.cover_path+'"/>';
                              qhtml += '</div>';
