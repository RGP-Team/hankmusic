...
class LangCodesTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
		...
		$sql = "INSERT INTO `i18n_language_codes` (`3letter`, `2letter`, `english_name`, `french_name`) VALUES
				('aar', 'aa', 'Afar', 'afar'),
				...
				('qaa', NULL, 'Reserved for local use', 'réservée à l''usage local'),
